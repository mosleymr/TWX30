...
#            $mode - Warp method ("E" = express, "S" = scan, "T" = twarp, "F" = figwarp) // EP Note: figwarp does a plot, then a getCourse, and macros the entire move
#            $pay - Pay tolls ("Y"/"N")
...
:Warp
  ...
  if (SECTORS > 5000) or ($dest < 600) // EP - I think this begins Mode "E"
    send $dest "*"
  else
    send $dest
  end
