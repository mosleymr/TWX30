...
setVar $oz_foton_version "OZ-PWarp Fast Foton 2.0"
...
#	if (SECTOR.WARPCOUNT[$sector] <> 2) or (SECTOR.WARPCOUNT <> 3)
#		goto :hehe5
#	end
:pwp_id_check
...
:gotem
	killAllTriggers
	subtract $ptorps 1
	send "' OZ Fast Foton Fired - Sector -> " $sector "!*"
...
:twarp_home_lock
	...
	goto :hoho5
:cant_buy
	send "'OZ Fast Foton - algn/xp conflict - switching to passive mode.*"
	setVar $run "off"
	goto :hoho5
