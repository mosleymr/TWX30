...
:surround
	...
	:StartSurround
		...
		######################################################################################
		#
		#     Randomized Surround v1.0 -- Lonestar
		#
		#     Generates a list of 100 Randomized Adjacents, then picks one of the 100
		#
		##################################################################
...
:wait_for_command
	...
	#setTextLineTrigger 	own_command_all	        :check_routing_all      "all"
...
#LS JAN-2019 Randomized Surround v1.0 -- Lonestar
#LS JAN-2019 Disabled the :checkSectorData ..which adds [B] and/or [MSL] to prompt
#LS JAN-2019 Incorporated TOYMAN/XANOS Mods; except spoof removal. Fixed some nonsense.
